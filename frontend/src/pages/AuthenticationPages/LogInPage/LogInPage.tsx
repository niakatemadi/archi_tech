...
const LogInPage = () => {
  ...
  useEffect(() => {
    if(state == "userAccountDeleted"){
      setMessageAlert("Compte supprimé avec succès !");
    }
    if(state == 'userLogOut'){
  ...
  async function SendLogInForm(datas : LogInFormDatas){
     ...
     if(user){
       ...
       if (token !=null && role=="admin"){
        ...
        setLoginFailedMessage("Votre email ou mot de passe est incorrect !");
        setMessageAlert("");
     }
  ...
  return (
    <div className='LogInPage'>
      <span className='LogInPage__failedMessage'>{LogInFailedMessage}</span>
      <span className='LogInPage__alertMessage'>{messageAlert}</span>
          <p className='LogInPage__title'> Se connecter</p>
          <div className='LogInPage__connectionMethods'>
          ...
          <div className='LogInPage__dividerBloc'>
